...
const (
	...
	Action_SessionRejected        Action = 8
...
type SessionRequest struct {
	...
	Action  Action       `protobuf:"varint,2,opt,name=action,proto3,enum=accelbyte.session.manager.Action" json:"action,omitempty"`
}
...
func (x *SessionRequest) GetSession() *GameSession {
	if x != nil {
		return x.Session
	}
	return nil
...
func (x *SessionRequest) GetAction() Action {
	if x != nil {
		return x.Action
	}
	return Action_None
...
type SessionUpdatedRequest struct {
	...
	SessionDiff *GameSession `protobuf:"bytes,3,opt,name=session_diff,json=sessionDiff,proto3" json:"session_diff,omitempty"`
	Action      Action       `protobuf:"varint,4,opt,name=action,proto3,enum=accelbyte.session.manager.Action" json:"action,omitempty"`
}
...
func (x *SessionUpdatedRequest) GetSessionDiff() *GameSession {
	if x != nil {
		return x.SessionDiff
	}
	return nil
}
...
type SessionStorageUpdatedRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	StorageOld *SessionStorage `protobuf:"bytes,1,opt,name=storage_old,json=storageOld,proto3" json:"storage_old,omitempty"`
	StorageNew *SessionStorage `protobuf:"bytes,2,opt,name=storage_new,json=storageNew,proto3" json:"storage_new,omitempty"`
	Session    *GameSession    `protobuf:"bytes,3,opt,name=session,proto3" json:"session,omitempty"`
	Action     Action          `protobuf:"varint,4,opt,name=action,proto3,enum=accelbyte.session.manager.Action" json:"action,omitempty"`
}

func (x *SessionStorageUpdatedRequest) Reset() {
	*x = SessionStorageUpdatedRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *SessionStorageUpdatedRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SessionStorageUpdatedRequest) ProtoMessage() {}

func (x *SessionStorageUpdatedRequest) ProtoReflect() protoreflect.Message {
	mi := &file_session_manager_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SessionStorageUpdatedRequest.ProtoReflect.Descriptor instead.
func (*SessionStorageUpdatedRequest) Descriptor() ([]byte, []int) {
	return file_session_manager_proto_rawDescGZIP(), []int{3}
}

func (x *SessionStorageUpdatedRequest) GetStorageOld() *SessionStorage {
	if x != nil {
		return x.StorageOld
	}
	return nil
...
func (x *SessionStorageUpdatedRequest) GetStorageNew() *SessionStorage {
	if x != nil {
		return x.StorageNew
	}
	return nil
...
func (x *SessionStorageUpdatedRequest) GetSession() *GameSession {
	if x != nil {
		return x.Session
	}
	return nil
...
func (x *SessionStorageUpdatedRequest) GetAction() Action {
	if x != nil {
		return x.Action
	}
	return Action_None
...
type SessionStorageResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Storage *SessionStorage `protobuf:"bytes,1,opt,name=storage,proto3" json:"storage,omitempty"`
	Session *GameSession    `protobuf:"bytes,2,opt,name=session,proto3" json:"session,omitempty"`
}

func (x *SessionStorageResponse) Reset() {
	*x = SessionStorageResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SessionStorageResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SessionStorageResponse) ProtoMessage() {}

func (x *SessionStorageResponse) ProtoReflect() protoreflect.Message {
	mi := &file_session_manager_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SessionStorageResponse.ProtoReflect.Descriptor instead.
func (*SessionStorageResponse) Descriptor() ([]byte, []int) {
	return file_session_manager_proto_rawDescGZIP(), []int{4}
}

func (x *SessionStorageResponse) GetStorage() *SessionStorage {
	if x != nil {
		return x.Storage
	}
	return nil
...
func (x *SessionStorageResponse) GetSession() *GameSession {
	if x != nil {
		return x.Session
	}
	return nil
...
type SessionStorage struct {
	...
	Storages *structpb.Struct `protobuf:"bytes,1,opt,name=storages,proto3" json:"storages,omitempty"`
}

func (x *SessionStorage) Reset() {
	*x = SessionStorage{}
	if protoimpl.UnsafeEnabled {
...
func (x *SessionStorage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SessionStorage) ProtoMessage() {}

func (x *SessionStorage) ProtoReflect() protoreflect.Message {
	mi := &file_session_manager_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SessionStorage.ProtoReflect.Descriptor instead.
func (*SessionStorage) Descriptor() ([]byte, []int) {
	return file_session_manager_proto_rawDescGZIP(), []int{6}
}

func (x *SessionStorage) GetStorages() *structpb.Struct {
	if x != nil {
		return x.Storages
	}
	return nil
...
func (*GameSession_BaseSession) Descriptor() ([]byte, []int) {
	return file_session_manager_proto_rawDescGZIP(), []int{5, 0}
}
...
func (*GameSession_DSInformation) Descriptor() ([]byte, []int) {
	return file_session_manager_proto_rawDescGZIP(), []int{5, 1}
}
...
func (*GameSession_Team) Descriptor() ([]byte, []int) {
	return file_session_manager_proto_rawDescGZIP(), []int{5, 2}
}
...
func (*GameSession_BaseSession_Configuration) Descriptor() ([]byte, []int) {
	return file_session_manager_proto_rawDescGZIP(), []int{5, 0, 0}
}
...
func (*GameSession_BaseSession_User) Descriptor() ([]byte, []int) {
	return file_session_manager_proto_rawDescGZIP(), []int{5, 0, 1}
}
...
func (*GameSession_Team_PartyMember) Descriptor() ([]byte, []int) {
	return file_session_manager_proto_rawDescGZIP(), []int{5, 2, 0}
}
...
var file_session_manager_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	0x22, 0x87, 0x12, 0x0a, 0x0b, 0x47, 0x61, 0x6d, 0x65, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	...
	0x75, 0x73, 0x56, 0x32, 0x1a, 0xc3, 0x01, 0x0a, 0x04, 0x54, 0x65, 0x61, 0x6d, 0x12, 0x19, 0x0a,
	...
	0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x1a, 0x42, 0x0a, 0x0b, 0x50, 0x61, 0x72, 0x74, 0x79, 0x4d,
	0x65, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x18, 0x0a, 0x07, 0x50, 0x61, 0x72, 0x74, 0x79, 0x49, 0x44,
	...
	,
...
var file_session_manager_proto_goTypes = []interface{}{
	...
	(*SessionRequest)(nil),                        // 1: accelbyte.session.manager.SessionRequest
	(*SessionUpdatedRequest)(nil),                 // 2: accelbyte.session.manager.SessionUpdatedRequest
	(*SessionResponse)(nil),                       // 3: accelbyte.session.manager.SessionResponse
	(*SessionStorageUpdatedRequest)(nil),          // 4: accelbyte.session.manager.SessionStorageUpdatedRequest
	(*SessionStorageResponse)(nil),                // 5: accelbyte.session.manager.SessionStorageResponse
	(*GameSession)(nil),                           // 6: accelbyte.session.manager.GameSession
	(*SessionStorage)(nil),                        // 7: accelbyte.session.manager.SessionStorage
	(*GameSession_BaseSession)(nil),               // 8: accelbyte.session.manager.GameSession.BaseSession
	(*GameSession_DSInformation)(nil),             // 9: accelbyte.session.manager.GameSession.DSInformation
	(*GameSession_Team)(nil),                      // 10: accelbyte.session.manager.GameSession.Team
	(*GameSession_BaseSession_Configuration)(nil), // 11: accelbyte.session.manager.GameSession.BaseSession.Configuration
	(*GameSession_BaseSession_User)(nil),          // 12: accelbyte.session.manager.GameSession.BaseSession.User
	(*GameSession_Team_PartyMember)(nil),          // 13: accelbyte.session.manager.GameSession.Team.PartyMember
	(*structpb.Struct)(nil),                       // 14: google.protobuf.Struct
	(*timestamppb.Timestamp)(nil),                 // 15: google.protobuf.Timestamp
}
var file_session_manager_proto_depIdxs = []int32{
	6,  // 0: accelbyte.session.manager.SessionRequest.session:type_name -> accelbyte.session.manager.GameSession
	0,  // 1: accelbyte.session.manager.SessionRequest.action:type_name -> accelbyte.session.manager.Action
	6,  // 2: accelbyte.session.manager.SessionUpdatedRequest.session_old:type_name -> accelbyte.session.manager.GameSession
	6,  // 3: accelbyte.session.manager.SessionUpdatedRequest.session_new:type_name -> accelbyte.session.manager.GameSession
	6,  // 4: accelbyte.session.manager.SessionUpdatedRequest.session_diff:type_name -> accelbyte.session.manager.GameSession
	0,  // 5: accelbyte.session.manager.SessionUpdatedRequest.action:type_name -> accelbyte.session.manager.Action
	6,  // 6: accelbyte.session.manager.SessionResponse.session:type_name -> accelbyte.session.manager.GameSession
	7,  // 7: accelbyte.session.manager.SessionStorageUpdatedRequest.storage_old:type_name -> accelbyte.session.manager.SessionStorage
	7,  // 8: accelbyte.session.manager.SessionStorageUpdatedRequest.storage_new:type_name -> accelbyte.session.manager.SessionStorage
	6,  // 9: accelbyte.session.manager.SessionStorageUpdatedRequest.session:type_name -> accelbyte.session.manager.GameSession
	0,  // 10: accelbyte.session.manager.SessionStorageUpdatedRequest.action:type_name -> accelbyte.session.manager.Action
	7,  // 11: accelbyte.session.manager.SessionStorageResponse.storage:type_name -> accelbyte.session.manager.SessionStorage
	6,  // 12: accelbyte.session.manager.SessionStorageResponse.session:type_name -> accelbyte.session.manager.GameSession
	9,  // 13: accelbyte.session.manager.GameSession.ds_information:type_name -> accelbyte.session.manager.GameSession.DSInformation
	8,  // 14: accelbyte.session.manager.GameSession.session:type_name -> accelbyte.session.manager.GameSession.BaseSession
	10, // 15: accelbyte.session.manager.GameSession.teams:type_name -> accelbyte.session.manager.GameSession.Team
	14, // 16: accelbyte.session.manager.SessionStorage.storages:type_name -> google.protobuf.Struct
	15, // 17: accelbyte.session.manager.GameSession.BaseSession.created_at:type_name -> google.protobuf.Timestamp
	15, // 18: accelbyte.session.manager.GameSession.BaseSession.expired_at:type_name -> google.protobuf.Timestamp
	15, // 19: accelbyte.session.manager.GameSession.BaseSession.updated_at:type_name -> google.protobuf.Timestamp
	14, // 20: accelbyte.session.manager.GameSession.BaseSession.attributes:type_name -> google.protobuf.Struct
	14, // 21: accelbyte.session.manager.GameSession.BaseSession.storages:type_name -> google.protobuf.Struct
	11, // 22: accelbyte.session.manager.GameSession.BaseSession.configuration:type_name -> accelbyte.session.manager.GameSession.BaseSession.Configuration
	12, // 23: accelbyte.session.manager.GameSession.BaseSession.members:type_name -> accelbyte.session.manager.GameSession.BaseSession.User
	15, // 24: accelbyte.session.manager.GameSession.DSInformation.requested_at:type_name -> google.protobuf.Timestamp
	13, // 25: accelbyte.session.manager.GameSession.Team.party_members:type_name -> accelbyte.session.manager.GameSession.Team.PartyMember
	14, // 26: accelbyte.session.manager.GameSession.BaseSession.Configuration.attributes:type_name -> google.protobuf.Struct
	15, // 27: accelbyte.session.manager.GameSession.BaseSession.User.updated_at:type_name -> google.protobuf.Timestamp
	1,  // 28: accelbyte.session.manager.SessionManager.OnSessionCreated:input_type -> accelbyte.session.manager.SessionRequest
	2,  // 29: accelbyte.session.manager.SessionManager.OnSessionUpdated:input_type -> accelbyte.session.manager.SessionUpdatedRequest
	4,  // 30: accelbyte.session.manager.SessionManager.OnSessionStorageUpdated:input_type -> accelbyte.session.manager.SessionStorageUpdatedRequest
	1,  // 31: accelbyte.session.manager.SessionManager.OnSessionDeleted:input_type -> accelbyte.session.manager.SessionRequest
	3,  // 32: accelbyte.session.manager.SessionManager.OnSessionCreated:output_type -> accelbyte.session.manager.SessionResponse
	3,  // 33: accelbyte.session.manager.SessionManager.OnSessionUpdated:output_type -> accelbyte.session.manager.SessionResponse
	5,  // 34: accelbyte.session.manager.SessionManager.OnSessionStorageUpdated:output_type -> accelbyte.session.manager.SessionStorageResponse
	3,  // 35: accelbyte.session.manager.SessionManager.OnSessionDeleted:output_type -> accelbyte.session.manager.SessionResponse
...
func file_session_manager_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_session_manager_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SessionStorageUpdatedRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_session_manager_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SessionStorageResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
